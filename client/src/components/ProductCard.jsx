...
const ProductCard = ({ image, category, title, price, rating }) => {
  return (
    <div className=" box-border w-72 w- h-112 outline outline-1 outline-silver hover:outline-2 hover:outline-red relative flex flex-col group after:absolute after:w-full after:h-full after:top-0 after:-z-10 after:bg-white   transition duration-250 ease-in-out">

      <figure className="box-border w-full h-1/2 flex items-center justify-center">
        <img className="h-[85%] box-border " src={image} alt="" />
      </figure>
