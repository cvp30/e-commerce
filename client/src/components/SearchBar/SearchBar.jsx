...
const SearchBar = () => {
  return (
    <div className='border-2 border-principal text-sm flex items-center rounded-lg w-full md:w-2/5 h-12 bg-white'>
      ...
      <select
        className='hidden md:block outline-0 rounded-l-lg w-4/12 h-full p-3'
      >
      ...
      <input 
        type="text" 
        placeholder="Search ..." 
        className="outline-0 p-3 w-11/12 md:w-7/12 bg-white rounded-r-lg rounded-l-lg md:rounded-l-none"
      />
